...
\label{quotesort}
\begin{bytefield}[endianness=little, bitwidth=0.0625\linewidth]{16}
  \bitheader{0,5,7,10,12,15}\\
  \bitbox{5}{} & \bitbox{11}{QS} \\
  \bitbox{5}{5} & \bitbox{3}{3} & \bitbox{2}{2} & \bitbox{2}{2}  & \bitbox{4}{4}  \\
  \bitbox{5}{QD} & \bitbox{3}{VT} & \bitbox{2}{R} & \bitbox{2}{TW}  & \bitbox{4}{SD}  \\
\end{bytefield}
...
\begin{bytefield}[endianness=little, bitwidth=0.125\linewidth]{8}
  ...
  \bitbox{2}{V} & \bitbox{2}{V} & \bitbox{2}{V or A} & \bitbox{2}{Pe}  \\
\end{bytefield}
